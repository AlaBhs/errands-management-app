...
import { Trash2, Plus, Loader2, CheckCircle2, Wallet } from 'lucide-react';
...
interface ExpensePanelProps {
  requestId: string;
  status: string;                        // RequestStatus string
  expenseSummary?: ExpenseSummaryDto;    // from RequestDetailsDto (inline)
}
  ...
  return (
    <div className="rounded-xl border bg-card shadow-sm overflow-hidden">
      ...
      <div className="border-b border-border bg-muted/30 px-5 py-3 flex items-center gap-2">
        ...
        {isReconciled && (
          <span className="ml-auto inline-flex items-center gap-1 rounded-full bg-emerald-100 dark:bg-emerald-950/30 px-2 py-0.5 text-xs font-medium text-emerald-700 dark:text-emerald-300">
