...
import {
  ...
  Clock, Package, Shield, Users, Zap,
} from "lucide-react";
...
function Nav({ onSignIn }: { onSignIn: () => void }) {
  return (
    <nav className="relative z-10 mx-auto flex max-w-7xl
...
function FeatureCard({
  ...
  return (
    <div className="group rounded-2xl border border-gray-100 bg-white
      ...
      <h3 className="mb-2 text-base font-semibold text-[#2E2E38]">
        {title}
      </h3>
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative overflow-hidden bg-[#2E2E38]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-16">
          ...
          {/* Headline */}
          <h1 className="max-w-2xl text-5xl font-black leading-[1.1]
                         tracking-tight text-white">
            Streamline Your{" "}
            <span className="text-[#FFE600]">Errand Operations</span>{" "}
            Across EY
          </h1>

          <p className="mt-6 max-w-xl text-lg leading-relaxed text-gray-300">
            A purpose-built platform for EY to manage, assign, and track
            internal errands — from request to proof of delivery — with
            full visibility for every stakeholder.
          </p>
          ...
          {/* Stats row */}
          <div className="mt-16 grid max-w-lg grid-cols-3 gap-4">
            {STATS.map((s) => (
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-16 md:grid-cols-2">
            ...
            <div>
              ...
              <Button
                onClick={signIn}
                className="mt-10 bg-[#2E2E38] text-white
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl border border-gray-100
                ...
                <div className="mb-4 grid grid-cols-3 gap-3">
                  {[
                    { label: "Total",     value: "248", color: "bg-[#2E2E38]" },
                    { label: "Active",    value: "12",  color: "bg-[#FFE600]" },
                    { label: "Done",      value: "236", color: "bg-emerald-500" },
                  ].map((c) => (
                    <div key={c.label}
                      className="rounded-xl border border-gray-100 p-3">
                      <div className={`mb-1.5 h-1.5 w-6 rounded-full ${c.color}`} />
                      <p className="text-xl font-black text-[#2E2E38]">
                        {c.value}
                      </p>
                ...
                <div className="space-y-2">
                  {[
                    { title: "Office supplies procurement", status: "Completed",  color: "bg-emerald-100 text-emerald-700" },
                    { title: "IT equipment pickup",         status: "In Progress", color: "bg-blue-100 text-blue-700"     },
                    { title: "Travel documents — visa",     status: "Pending",     color: "bg-amber-100 text-amber-700"   },
                  ].map((r) => (
                    <div key={r.title}
                      className="flex items-center justify-between
                                 rounded-lg bg-gray-50 px-3 py-2.5">
                      <p className="truncate text-xs font-medium
                                    text-gray-700 max-w-[160px]">
                        {r.title}
                      </p>
                ...
                <div className="mt-5 flex items-center gap-2 border-t
                  ...
                  <div className="flex h-6 w-6 items-center justify-center
                                  rounded bg-[#2E2E38]">
                    <span className="text-[9px] font-black text-[#FFE600]">
                      EY
                    </span>
                  </div>
                  <p className="text-xs text-gray-400">
                    EY Errands Management System
                  </p>
                </div>
              </div>
            </div>
