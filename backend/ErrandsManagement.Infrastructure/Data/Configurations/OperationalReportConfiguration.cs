...
public sealed class OperationalReportConfiguration : IEntityTypeConfiguration<OperationalReport>
{
    public void Configure(EntityTypeBuilder<OperationalReport> builder)
    {
        ...
        builder.Property(r => r.MetricsSnapshot)
            .IsRequired();

        builder.Property(r => r.AiAnalysis);

        builder.Property(r => r.GeneratedAt)
            .IsRequired();

        builder.Property(r => r.PeriodFrom)
            .IsRequired();

        builder.Property(r => r.PeriodTo)
            .IsRequired();

        builder.Property(r => r.GeneratedByUserId)
            .IsRequired();
