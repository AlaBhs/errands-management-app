...
public static class DbInitializer
{
        ...
        ILogger logger)
    {
        ...
        static void SetAssignmentDates(Request request, DateTime startedAt, DateTime completedAt)
        {
            // Must access the private backing field _assignments directly —
            // the IReadOnlyCollection property returns a copy so SetValue on
            // elements of that copy has no effect on the tracked instances.
            ...
            completedProp!.SetValue(assignment, completedAt);
        }
        ...
        SetAssignmentDates(h4, m4.AddDays(2), m4.AddDays(2).AddMinutes(30));
        ...
        SetAssignmentDates(h8, m3.AddDays(3), m3.AddDays(3).AddMinutes(150));
        ...
        SetAssignmentDates(h11, m2.AddDays(2), m2.AddDays(2).AddMinutes(180));
        ...
        SetAssignmentDates(h12, m2.AddDays(3), m2.AddDays(3).AddMinutes(35));
        ...
        SetAssignmentDates(h14, m1.AddDays(2), m1.AddDays(2).AddMinutes(65));
        ...
        SetAssignmentDates(h17, m0.AddDays(-5), m0.AddDays(-5).AddMinutes(110));
